    ...
    return (
      <div class="collection">
        <div class="info">
          ...
          <div
            class="info_avatar"
            onclick="removeall(this.state.collection.id})"
          >
        ...
        <div class="list">
          <ul class="toolbar">
            ...
            <button
              ...
              onclick="setab(event, 'lista', true)"
            >
              {" "}
              <i class="fas fa-th"></i>
            </button>
            <button class="tablinks" onclick="setab(event, 'grid', true)">
              {" "}
              <i class="fas fa-bars"></i>
            </button>
          </ul>
          <div class="input-episode" style="display:none;">
          ...
          {this.state.collection.list.map((episodes) => (
            <li class="lista" key={episodes.id}>
              <Link
                class="texto_line"
                href={"/EpisodesDetails/" + episodes.episode_id}
              >
                <div
                  class="img"
                  style={{
              ...
              <div
                class="info_avatar"
                onclick="removeelement({episodes.episode_id})"
              >
                <i class="fa fa-trash" style="font-size:20px;"></i>
              </div>
            </li>
