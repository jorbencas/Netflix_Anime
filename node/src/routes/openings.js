...
router.get('/id/:id', async function(req, res, next){
  try {
    ...
    " a.titulo_ca as anime_titulo_ca, m.type, m.name, m.extension, a.siglas, o.num, a.idiomas " + 
...
router.get('/anime/:id', async function(req, res, next){
  try {
    ...
    " m.type, m.extension, a.siglas, o.num, a.idiomas " +
    " FROM animes AS a " +
    " INNER JOIN openings as o ON a.id = o.anime " +
    " INNER JOIN media AS m ON m.anime = o.anime " +
