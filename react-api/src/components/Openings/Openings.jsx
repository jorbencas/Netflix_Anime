...
const Openings = () => {
        ...
        return (
            <table className="table">
                <tbody className="table-tbody" role="tablist">
                    {
                        openings !== null ? openings.map( episode => (
                            <Link to={'/OpeningsDetails/ ' + episode.id} >
    ...
    return (
        <>
            ...
            {openings !== null && view === 'list' ? <GridVideo elements={openings} kind='openings' field='nombre' /> : null}
        </>
    )
}
